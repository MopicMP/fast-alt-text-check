...
[![PyPI version](https://badge.fury.io/py/fast-alt-text-check.svg)](https://pypi.org/project/fast-alt-text-check/)
...
```bash
pip install fast-alt-text-check
```
...
from fast_alt_text_check import batch
